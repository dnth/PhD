...
class socNetwork(object):
    ...
    def build_network(self):
        ...
        '''
        model = Sequential()
        model.add(LSTM(self.hidden_size_1, input_shape=(look_back, feature), return_sequences=True))
        model.add(LSTM(self.hidden_size_2, return_sequences=True))
        model.add(LSTM(self.hidden_size_3))
